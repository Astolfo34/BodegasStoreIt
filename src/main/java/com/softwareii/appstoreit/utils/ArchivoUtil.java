...
public  class ArchivoUtil {
    ...
    public static void guardarRegistroLog(String mensajeLog, String usuario, int nivel, String accion, String rutaArchivo) {
        String log = "";
        ...
        try {
            ...
            switch (nivel) {
                case 1:
                    LOGGER.log(Level.INFO, accion + "," + usuario + ","+ mensajeLog + "," + fechaSistema);
                    break;

                case 2:
                    LOGGER.log(Level.WARNING, accion + "," + usuario + ","+ mensajeLog + "," + fechaSistema);
                    break;

                case 3:
                    LOGGER.log(Level.SEVERE, accion + "," + usuario + ","+ mensajeLog + "," + fechaSistema);
                    break;
